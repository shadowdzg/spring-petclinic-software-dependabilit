...
public class Owner extends Person {
	...
	/**
	 * Adds a new pet to this owner's pet collection. Only adds the pet if it is new (not
	 * yet persisted).
	...
	/**
	 * Return the Pet with the given id, or null if none found for this Owner. Only
	 * searches for pets that are already persisted (not new).
	 * @param id to test
